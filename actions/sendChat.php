...
// $mensagem .= "<p style='font-size: 16px;'><strong>Nome:</strong> " . htmlspecialchars($_POST['nome']) . "</p>";  
// $mensagem .= "<p style='font-size: 16px;'><strong>E-mail:</strong> " . htmlspecialchars($_POST['email']) . "</p>";
// $mensagem .= "<p style='font-size: 16px;'><strong>Telefone:</strong> " . htmlspecialchars($_POST['telefone']) . "</p>";
// $mensagem .= "</div>";
